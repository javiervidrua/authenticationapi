...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserPut', function() {
      beforeEach(function() {
        instance = new AuthenticationApi.UserPut();
      });

      it('should create an instance of UserPut', function() {
        // TODO: update the code to test UserPut
        expect(instance).to.be.a(AuthenticationApi.UserPut);
      });
