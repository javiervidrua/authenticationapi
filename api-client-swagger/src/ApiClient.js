...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AuthenticationApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://localhost:3443/api/v1
     */
    this.basePath = 'https://localhost:3443/api/v1'.replace(/\/+$/, '');
    ...
    this.authentications = {
      'ApiKeyAuth': {type: 'apiKey', 'in': 'query', name: 'jwt'}
    };
    /**
